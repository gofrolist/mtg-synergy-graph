...
**Eligible gaps (covered_rate < threshold)**: 525
...
- ⚠️ **Template caution**: 6 revert(s) elsewhere on this template — most recent 2026-04-20T18:25:25.846725+00:00: _HARMFUL (-0.388 NDCG aggregate across 6 cmdrs). Qala -0.227, Kyler -0.103, Savanti Romero -0.089 regressed. Only Ezio +0.031 benefited. Two-tier design (counter_doubler=28, proliferate=82) with multip_
- ✅ **Signature already shipped**: 1 passing apply(s) on this exact signature — rule should be in the registry; investigate runtime mismatch.
...
### #23: `trigger.ChangesZoneAll[->Battlefield]`
- **Reach**: 8 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 8.0
- **Template**: `needs_template`
...
### #24: `replacement.Moved[ETBTapped]`
