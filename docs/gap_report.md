...
**Eligible gaps (covered_rate < threshold)**: 535
...
### #4: `keyword.Ward:2[*]`
- ⚠️ **Prior failure**: 1 revert(s) on this template — most recent 2026-04-19T03:18:05+00:00: _Per-rule impact audit (scripts/_audit_rule_impact.py): HARMFUL — net hi_syn delta -5 across 27 touched commanders. Sovereign Okinec Ahau loses 3 hi_syn_hits (3 -> 0); Mikey & Don and Adrix and Nev los_
- ✅ **Prior success**: 11 passing apply(s) — rule should already be in the registry; check why it's not catching this signature.
