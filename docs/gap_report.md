...
**Eligible gaps (covered_rate < threshold)**: 522
...
### #3: `scales_with.CardPower[*]`
- **Reach**: 64 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 64.0
- **Template**: `needs_template`
- **Rationale**: No template in the catalog matches `scales_with.CardPower[*]` and no registered rule covers any commander carrying this signature. Pure gap — needs both a new rule and (probably) a new template entry.
- **Exemplar commanders** (no rule activation): Agatha of the Vile Cauldron, Alesha, Who Laughs at Fate, Amy Rose, Auron, Venerated Guardian, Ayesha Tanaka, Armorer, Baeloth Barrityl, Entertainer, Captain Ripley Vance, Carmen, Cruel Skymarcher
- **Gate sketch**: `port_type='scales_with' AND event_class='CardPower'`

### #4: `cost.remove_counter[*]`
...
### #7: `scales_with.ValidHand Card.YouOwn[*]`
...
### #10: `scales_with.LifeYouGainedThisTurn[*]`
...
- ⚠️ **Template caution**: 3 revert(s) elsewhere on this template — most recent 2026-04-19T17:40:16+00:00: _HARMFUL (-4 sum_Δ across 9 cmdrs). Aang and Katara -3 (5→2 hi_syn). The tapped axis is heterogeneous — untap engines / opp-tap lock / tap-scaling commanders all want different cards. A single tier-ran_
...
### #16: `scales_with.ResolvedThisTurn[*]`
...
### #18: `replacement.DamageDone[Prevent]`
- **Reach**: 10 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 10.0
...
### #19: `scales_with.wasCastFromYourHandByYou.1.0[*]`
- **Reach**: 10 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 10.0
- **Template**: `needs_template`
...
### #20: `scales_with.CastTotalManaSpent[*]`
...
### #22: `scales_with.RememberedNumber[*]`
- **Reach**: 9 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 9.0
- **Template**: `needs_template`
...
### #24: `effect.ChangeZoneAll[Library->Library]`
...
### #26: `scales_with.ValidGraveyard Creature.YouOwn[*]`
- **Reach**: 8 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 8.0
- **Template**: `needs_template`
...
### #28: `trigger.ChangesZoneAll[->Battlefield]`
- **Reach**: 8 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 8.0
- **Template**: `needs_template`
...
### #31: `keyword.etbCounter:P1P1:X:no[*]`
...
### #32: `scales_with.CardCounters.ALL[*]`
- **Reach**: 7 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 7.0
- **Template**: `needs_template`
...
### #33: `trigger.ChangesZoneAll[Graveyard->Any]`
- **Reach**: 7 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 7.0
- **Template**: `needs_template`
...
### #34: `replacement.DamageDone[DmgTwice]`
...
### #38: `keyword.etbCounter:P1P1:Y:no[*]`
...
### #39: `scales_with.AttackersDeclared[*]`
- **Reach**: 6 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 6.0
- **Template**: `needs_template`
...
### #42: `scales_with.ThisTurnEntered_Graveyard_from_Battlefield_Creature[*]`
- **Reach**: 6 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 6.0
- **Template**: `needs_template`
...
### #43: `trigger.ChangesZoneAll[Battlefield->Graveyard]`
- **Reach**: 6 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 6.0
- **Template**: `needs_template`
...
### #45: `effect.ChangeZoneAll[Battlefield->Exile]`
- **Reach**: 5 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 5.0
- **Template**: `needs_template`
...
### #46: `effect.ChangeZoneAll[Exile->Library]`
- **Reach**: 5 commanders carrying this signature; 0 get any rule activation (0%).
- **Impact**: 5.0
- **Template**: `needs_template`
...
### #49: `keyword.etbCounter:DIVINITY:1:CheckSVar$[*]`
...
### #50: `keyword.etbCounter:Indestructible:1:CheckSVar$[*]`
