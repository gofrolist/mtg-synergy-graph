...
SEMANTIC_BRIDGES = {
    ...
    ("put-counter-p1p1", "counter-added-p1p1"): 1.0,
    ("put-counter-m1m1", "counter-added-m1m1"): 1.0,
    ("put-counter-energy", "counter-added-energy"): 1.0,
    ("put-counter-p1p1", "counter-added"): 1.0,   # p1p1 matches generic
    ("put-counter-all", "counter-added-p1p1"): 1.0,
    ...
    ("proliferate", "counter-added-p1p1"): 1.0,
    ("proliferate", "counter-added-energy"): 1.0,
