...
KNOWN_EFFECT_VERBS: frozenset[str] = frozenset({
    "Abandon", "ActivateAbility", "AddOrRemoveCounter", "AddPhase",
    "AddTurn", "AdvanceCrank", "Airbend", "AlterAttribute", "Amass",
    "Animate", "AnimateAll", "AssembleContraption", "AssignGroup",
    "Attach", "Balance", "BecomeMonarch", "BecomesBlocked", "BidLife",
    "BlankLine", "Blight", "Block", "Branch", "ChangeCombatants",
    "ChangeSpeed", "ChangeTargets", "ChangeText", "ChangeX",
    "ChangeZone", "ChangeZoneAll", "ChaosEnsues", "Charm", "ChooseCard",
    "ChooseColor", "ChooseDirection", "ChooseEvenOdd", "ChooseNumber",
    "ChoosePlayer", "ChooseSector", "ChooseSource", "ChooseType",
    "Clash", "Cleanup", "Cloak", "Clone", "Connive", "ControlPlayer",
    "ControlSpell", "CopyPermanent", "CopySpellAbility", "Counter",
    "DamageAll", "DamageResolve", "DayTime", "DealDamage", "Debuff",
    "DelayedTrigger", "Destroy", "DestroyAll", "Detain", "Dig",
    "DigMultiple", "DigUntil", "Discard", "Discover", "Draft",
    "DrainMana", "Draw", "EachDamage", "Earthbend", "Effect",
    "EndCombatPhase", "EndTurn", "Endure", "ExchangeControl",
    "ExchangeControlVariant", "ExchangeLife", "ExchangeLifeVariant",
    "ExchangePower", "ExchangeTextBox", "ExchangeZone", "Explore",
    "Fight", "FlipACoin", "FlipOntoBattlefield", "Fog", "GainControl",
    "GainControlVariant", "GainLife", "GainOwnership", "GameDrawn",
    "GenericChoice", "Goad", "Heist", "ImmediateTrigger", "Incubate",
    "Intensify", "Investigate", "Learn", "LookAt", "LoseLife",
    "LosesGame", "MakeCard", "Mana", "ManaReflected", "Manifest",
    "ManifestDread", "Meld", "Mill", "MoveCounter", "MultiplePiles",
    "MultiplyCounter", "MustBlock", "NameCard", "OpenAttraction",
    "PeekAndReveal", "PermanentCreature", "PermanentNoncreature",
    "Phases", "Planeswalk", "Play", "Poison", "PreventDamage",
    "Proliferate", "Protection", "ProtectionAll", "Pump", "PumpAll",
    "PutCounter", "PutCounterAll", "Radiation", "RearrangeTopOfLibrary",
    "Regenerate", "RemoveCounter", "RemoveCounterAll", "RemoveFromCombat",
    "RemoveFromGame", "RemoveFromMatch", "ReorderZone", "Repeat",
    "RepeatEach", "RestartGame", "Reveal", "RevealHand",
    "ReverseTurnOrder", "RingTemptsYou", "RollDice", "RollPlanarDice",
    "RunChaos", "Sacrifice", "SacrificeAll", "Scry", "Seek",
    "SetInMotion", "SetLife", "SetState", "Shuffle", "SkipPhase",
    "SkipTurn", "StoreSVar", "Subgame", "Surveil", "SwitchBlock",
    "TakeInitiative", "Tap", "TapAll", "TapOrUntap", "TapOrUntapAll",
    "TaporUntapAll", "TimeTravel", "Token", "TwoPiles", "Unattach",
    "UnlockDoor", "Untap", "UntapAll", "Venture", "VillainousChoice",
    "Vote", "WinsGame",
...
DELIBERATELY_IGNORED: frozenset[str] = frozenset({
    "AdvanceCrank", "AssembleContraption", "OpenAttraction",    # Contraption
    "Vote", "VillainousChoice",                                  # Voting
    "RollDice", "RollPlanarDice", "FlipACoin", "ChaosEnsues",    # Chaos
    "RunChaos",                                                  # Chaos
    "Planeswalk", "SetInMotion",                                 # Planar
    "AddTurn", "AddPhase", "SkipPhase", "SkipTurn", "Phases",    # Temporal
    "EndTurn", "EndCombatPhase",                                 # Temporal
    "TimeTravel",                                                # Temporal
    "ExchangeLife", "ExchangeLifeVariant", "ExchangePower",      # Exchange
    "ExchangeZone", "ExchangeControl", "ExchangeControlVariant", # Exchange
    "ExchangeTextBox",                                           # Exchange
    "Balance", "BidLife", "ChangeSpeed", "ChangeText",           # Niche
    "RestartGame", "Subgame", "GameDrawn", "Draft",              # Special
    "ReorderZone", "RearrangeTopOfLibrary",                      # Library
    "ReverseTurnOrder", "BecomeMonarch", "TakeInitiative",       # Monarch/initiative
    "RingTemptsYou",                                             # LotR
    "NameCard", "MakeCard", "StoreSVar", "SetState",             # State tracking
    "Abandon", "BlankLine", "Cleanup", "DamageResolve",          # Engine internals
    "DelayedTrigger", "ImmediateTrigger", "Effect",              # Engine internals
...
def _load_effect_verbs(db_path: Path) -> frozenset[str]:
    ...
    try:
        rows = conn.execute(
            "SELECT DISTINCT event_class FROM card_ports WHERE port_type = 'effect'"
        ).fetchall()
    finally:
        conn.close()
...
def test_deliberately_ignored_verbs_are_in_known_set():
    ...
    assert not drift, (
        f"DELIBERATELY_IGNORED references verbs not in the snapshot: "
        f"{sorted(drift)}"
    )
